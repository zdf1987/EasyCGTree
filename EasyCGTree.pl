...
if ($ARGV[3] eq "nucl") {
	$blast = "tblastn";
	print "NOTE: The input directory $ARGV[1] must included genomes of fasta-formated!\n\n";
	print LOG "NOTE: The input directory $ARGV[1] must included genomes of fasta-formated!\n\n";
} elsif ($ARGV[3] eq "prot") {
	$blast = "blastp";
	print "NOTE: The input directory $ARGV[1] must included proteomes of each strain!\n\n";
	print LOG "NOTE: The input directory $ARGV[1] must included proteomes of each strain!\n\n";
} else {
	print join("\n",@usage)."\n"; 
	print LOG "WARNING: Problematic command line!\n\n";
	die "WARNING: Problematic command line!\n\n";
...
foreach (@in7) {
	...
	unless (system "$program", @para) {#############################
		$num7++;
		print "Step 7: $_ has completed! It is the $num7/$ingene file.\n";
		print LOG "Step 7: $_ has completed! It is the $num7/$ingene file.\n";
	} else {
